...
```{r  results=TRUE, fig.width=8, fig.cap="Velikost učinka pri analizi variance za pokritost intervala zaupanja"}
...
Pri tem se moramo zavedati, da znotraj spremenljivke model ni samo glm ali ols, vendar so upoštevani še ne polni modeli. To poudarimo zato, ker je učinek najverjetneje posledica nepolnih modelov, kjer smo tudi v prejšnjih prikazih zaznali vpliv, medtem ko med ols in glm modelom nismo opazili razlik. 
...
```{r results=TRUE, fig.width=8, fig.cap="Velikost učinka pri analizi variance za širino intervala zaupanja"}
par(mar = c(5.1, 3.1, 4.1, 0))
