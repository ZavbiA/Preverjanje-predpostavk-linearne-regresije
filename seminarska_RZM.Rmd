...
```{r fig.cap="Grafični prikaz rezultatov za primer n=100, vključene vse spremenljivke, porazdelitev napak=gamma(1,5)"}
source("rezultati1.R")
...
legend("center", col = 1:6, legend = c("presecisce", "X1", "X2", "X3", "X4", "X5"), lty = 1:6)
