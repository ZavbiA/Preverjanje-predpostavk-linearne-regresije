...
Normalni linearni model rešujem z metodo najmanjših kvadratov ali pa z metodo največjega verjetja, kjer maksimiziramo log-verjetnostno funkcijo.

V našem primeru bomo za ocenjevanje parametrov pri linearni regresiji uporabljali funkcijo `lm`, ki v splošnem uporablja metodo najmanjših kvadratov (OLS), zato v je v nadaljevanju podrobneje predstavljena samo ta metoda.

Metodo najmanjših kvadratov (MNK) je pri 16 letih odkril nemški matematik Carl F. Gauss. Zaradi svojih lastnosti je najbolj razširjena metoda ocenjevanja regresijskih koeficientov 
(Pfajfar, 2018, str.53).
